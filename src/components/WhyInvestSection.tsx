              ...
              <CardContent className="pt-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Imparare a gestire i tuoi risparmi in autonomia è più semplice di quanto pensi con l'aiuto di <b>FORMATORI CERTIFICATI AIEF (Associazione Italiana Educatori Finanziari) - riconosciuti dal Ministero dell'Economia e Sviluppo</b>. Con un metodo pratico e accessibile, basato sugli ETF, puoi costruire un portafoglio efficiente, ridurre i costi e proteggere il tuo futuro. Non serve esperienza: serve solo la volontà di smettere di delegare 
                    </p>
                  </div>
                </div>
              </CardContent>
